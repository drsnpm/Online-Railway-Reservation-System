        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card paint-card">
                    <div class="card-body">
                        <p class="fs-4 text-center" style="font-size: 2rem;">Passenger Register</p>
                        ...
                        <br>Do you have an account? <a href="pass_login.jsp" class="text-decoration-none">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
